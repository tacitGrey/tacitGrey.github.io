(function(d, c) {
    var a = "c7611038ee0a8a1d6decc9bd53035acf";
    ...
    try {
        if (!c.reviveAsync.hasOwnProperty(a)) {
            var f = c.reviveAsync[a] = {
                ...
                apply: function(g) {
                    if (g.zones.length) {
                        var e = d.location.protocol == "http:" ? "http://162.218.115.228/delivery/asyncspc.php": "https://162.218.115.228/delivery/asyncspc.php";
